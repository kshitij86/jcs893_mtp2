...
def get_rois(img, pupil_circle, ext_circle, show=False):
    ...
    jj=int(np.round(2.5*ext_circle[2]))
    kk=int(np.round(1.25*ext_circle[2]))
    rois['right-side']['img'] = \
        rois['right-side']['img'][0:jj, 0:kk]
    rois['left-side']['img'] = \
        rois['left-side']['img'][0:jj, 0:kk]
    rois['bottom']['img'] = \
        rois['bottom']['img'][0:kk, 0:jj]
    rois['complete']['img'] = \
        rois['complete']['img'][0:jj, 0:jj]
